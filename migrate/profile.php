...
<div  class="max-w-full mx-auto">
     ...
     <div class="bg-white shadow-lg rounded px-12 pt-12">
  <div class="px-4 bg-white sm:px-0 mx-12">
    <h3 class="text-lg uppercase font-semibold leading-7 py-4 text-gray-900">Applicant Information</h3>
    <hr>
    <p class="mt-1 max-w-2xl text-base font-semibold capitalize leading-6  pb-4 text-gray-500">Personal details and application.</p>
  </div>
  ...
  <div class="mt-6 border-t border-gray-100">
    <dl class="divide-y divide-gray-100">
      <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
        ...
        <dd class="mt-1 text-sm leading-6 text-gray-700 font-medium italic sm:col-span-2 sm:mt-0"><?php echo $user_data['first_name'].' '.$user_data['last_name']; ?></dd>
      </div>
      <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
        <dt class="text-sm font-medium leading-6 text-gray-900">Application for</dt>
        <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 capitalize font-semibold"><img class="w-4 h-4 flex inline-flex mx-2" src="/static/img/ca.jpg">Canada visa </dd>
      </div>
      <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
        <dt class="text-sm font-medium leading-6 text-gray-900">Email address</dt>
        <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 font-medium italic sm:mt-0"><?php echo $user_data['email']; ?></dd>
      </div>

      <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
        <dt class="text-sm font-medium leading-6 text-gray-900">About</dt>
        <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 font-medium italic sm:mt-0"> 
